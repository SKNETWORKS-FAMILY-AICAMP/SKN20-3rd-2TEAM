...
│   │
│   ├── 03_rag/                     # RAG 코어 로직
│   │   └── langgraph_hybird.py      # LangGraph 기반 멀티 라우팅 RAG 시스템
│   │
│   ├── 04_ui/                      # 프론트엔드 / 서비스 레이어
...
| 구분 | 기술 | 설명 |
|------|-------|-------|
| **UI 구조** | 🌐 HTML5 + JS | 단일 페이지 챗봇 인터페이스 |
...
| **벡터 저장소** | 🗄️ ChromaDB | 임베딩 벡터 기반 빠른 검색을 위한 저장소 |
...
### 🤖 5.5 `langgraph_hybird.py` — LangGraph 기반 RAG 검색 엔진
...
### 6.3 📚 트렌드 논문 검색 결과 (by HuggingFace WeeklyPapers)
