...
class SimpleRAGSystem:
    ...
    - user_question: the user’s question.
      - If you are responding using retrieved documents(including huggingface_url):
    ...
    - In case of "NO_RELEVANT_PAPERS" (not using retrieved documents), mark it as "HuggingFace paper: None" and enter the content searched on the web using duckduckgo.
        - One-line summary
        - Detailed explanation
        - source : DuckDuckgo (Two URL links related to the answer)
        - DO NOT output "Sources summary".
        - DO NOT list any papers.
        - Only output DuckDuckGo results as the two URLs.


    [Context Handling]

    - If the context is **"NO_RELEVANT_PAPERS"**, it means:
        - DO NOT refer to any HuggingFace papers.
        ...
        - DO NOT refer to any HuggingFace papers.
        - Use ONLY the WebResults provided below to answer the question.
        - WebResults are NOT research papers. Treat them as general information sources.
        - Output the answer in the usual format (one-line summary, detailed explanation, source URLs)
        - DO NOT output "Sources summary".
        - DO NOT list any papers.
        - Only output DuckDuckGo results as the two URLs.

                 
    - If the context contains one or more papers (including huggingface_url):
    ...
    - page_content (text)
    - metadata: title, authors, github_url, huggingface_url, upvoteetc.
    ...
    - If you do not find a paper that matches your question (In case of "NO_RELEVANT_PAPERS") and use duckduckgo web search,
        ⚠ when you answer by web search, YOU MUST USE ONLY BELOW THIS FORMAT !!!! 
